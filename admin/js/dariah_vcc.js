jQuery(document).ready(function($) {
  ...
  jQuery('.post-type-dariah_vcc #publish').click(function(event) {
    jQuery('#dariah-error').remove();

    var errors = [];
    var title = jQuery('.post-type-dariah_vcc input[name="post_title"]').val();
    var leaders = jQuery('.post-type-dariah_vcc select[name="leaders[]"]').val();
    if (title === '') {
