...
<?php
	...
	if (in_array($thisCat->slug, $sliders)) {
		echo '<div>';
		echo do_shortcode('[rev_slider alias="' . $thisCat->slug . '"]');
		echo '</div>';
	}
?>
...
<?php } ?>
 ...
 <div class="dariah_author">
	 <div class="image_container">
		 <?php echo get_avatar( get_the_author_meta( 'ID' ), 32 ); ?>
	 </div>
 </div>
 <div class='dariah_date'>
	  <span class="day"><?php the_time('j'); ?></span>
 	  <span class="month"><?php the_time('M'); ?></span>
 </div>
 <div class="dariah_post">
<?php
...
if( $post_format == 'quote' ){
 ...
 ?>
  <div class="post_ctn" itemscope itemtype="https://schema.org/Blog">
    <!-- .title -->
    ...
    <div class="post-info"><?php echo __('By','thefoxwp') ?> <span itemprop="author" itemscope itemtype="http://schema.org/Peron"><span itemprop="name"><?php the_author(); ?></span></span> </div>
