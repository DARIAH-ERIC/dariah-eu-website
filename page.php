...
$pageTitle = $isEventPage === 0 ? "Events" : get_the_title();
...
<div class="page_title_ctn <?php if($titlebg_color !== ''){ echo 'white'; } ?>">
  ...
  <?php if($bc !== 'no') {  ?>
<div id="breadcrumbs">
  <?php if (function_exists('dariah_breadcrumbs') && $isEventPage !== 0) dariah_breadcrumbs(); ?>
  <?php if ($isEventPage === 0) { ?>
  	<div id="crumbs">
...
<div class="section def_section">
 ...
 ?>
    <div id="posts" class=" <?php if ( $p_sidebar == 'right' ) { echo 'left_posts '; } else { echo 'right_posts ';} if ( $sb_style == 'business_sb'){echo " business_posts";} ?>">
      <?php  }else{ ?>
<div id="fw_c" class="clearfix tf_single_page" itemprop="articleBody">
    <?php } ?>
      ...
      <?php if ( is_active_sidebar( 'thefox_mc_sidebar' ) || $isEventPage === 0 ) { generated_dynamic_sidebar(); } ?>
    </div>
