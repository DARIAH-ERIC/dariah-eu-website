...
/// Check title style
if ( $title !== 'no' ) { ?>
    <div class="page_title_ctn <?php if ( $titlebg_color !== '' ) {
		echo 'white';
	} ?>">
        <div class="wrapper table_wrapper">
			...
			<?php if ( $bc !== 'no' ) { ?>
                <div id="breadcrumbs">
					<?php if ( function_exists( 'dariah_breadcrumbs' ) ) {
						dariah_breadcrumbs();
					} ?>
                </div>
			<?php } ?>
...
<div class="section def_section">
    <div class="wrapper section_wrapper">
		...
		?>
        <div id="posts" class=" <?php if ( $p_sidebar == 'right' ) {
			echo 'left_posts ';
		} else {
			echo 'right_posts ';
		}
		if ( $sb_style == 'business_sb' ) {
            ...
            <div id="fw_c" class="clearfix tf_single_page">
				<?php } ?>
                <div itemprop="review"><?php the_content(); ?></div>
				<?php
			...
			<?php if ( $p_sidebar == 'right' || $p_sidebar == 'left' ) { ?>
                <div id="sidebar" class=" <?php if ( $p_sidebar == 'right' ) {
					echo "right_sb";
				} else {
					echo "left_sb";
				}
				if ( $sb_style == 'business_sb' ) {
					echo " business_sidebar";
				} ?> ">
					<?php if ( is_active_sidebar( 'thefox_mc_sidebar' ) ) {
