...
if(get_post_meta($post->ID, 'rd_show_slider', true) == 'yes') {
 ...
 ?>
  <div class="post_ctn clearfix" itemscope itemtype="https://schema.org/Blog">
    <!-- .title -->
    <div class="post-title">
      <h2 itemprop="name"><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">
        <?php the_title(); ?>
        </a></h2>
    </div>
     <!-- .title END-->
     <!-- post-info-top -->
    <div class="post-info"><?php echo __('By','thefoxwp') ?> <schema itemprop="author" itemscope itemtype="http://schema.org/Peron"><schema itemprop="name"><?php the_author_posts_link(); ?></schema></schema>    |    <?php the_category(', '); ?> </div>
    <!-- post-info END-->
    <!-- .entry -->
...
<?php
	...
	if( get_the_post_thumbnail() ) {
		echo "<div class='post-attachement' itemprop='thumbnailUrl'>";
 ...
 ?>
  <div class="post_ctn">
    ...
    <div class="post-title">
     ...
     <!-- .title END-->
     <!-- post-info-top -->
    <div class="post-info" itemprop="author" itemscope itemtype="http://schema.org/Person"><?php echo __('By','thefoxwp') ?> <span itemprop="name"><?php the_author(); ?></span></div>
